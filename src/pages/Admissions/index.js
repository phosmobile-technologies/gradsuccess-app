    ...
    return (
      <Layout>
        ...
        <TitleAndText
          ...
          text="University admissions are a daunting process, from personal statements, reference letters and several certificating tests (IELTS, GMAT & GMAT to name a few), there’s so much involved.  At GradSuccess, we have expertise in preparing our clients for the most competitive universities. Through our novel array of packages, we can provide our clients with cutting-edge services ranging from reviews, redrafts and one-on-one coaching about preferred options. "
        />
