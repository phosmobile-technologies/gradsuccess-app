      ...
      <Layout>
        ...
        >
          <div className="content">
            {this.state.showCoverLetterReviewForm && (
              <CoverLetterReviewForm package={this.state.package} />
            )}
            {this.state.showCoverLetterRedraft && (
              <CoverLetterRedraft package={this.state.package} />
            )}
            {this.state.showGraduateSchoolEssayRedraftForm && (
              <GraduateSchoolEssayRedraftForm package={this.state.package} />
            )}
            {this.state.showGraduateSchoolStatementReviewForm && (
              <GraduateSchoolStatementReviewForm package={this.state.package} />
            )}
            {this.state.showResumeReviewForm && (
              <ResumeReviewForm package={this.state.package} />
            )}
          </div>
        </div>
      </Layout>
