...
import { MARK_COMPLETE_COVER_LETTER_REDRAFT } from "../graphql/mutations"
  ...
  completedRatingProcess() {
    ...
    fetch(url, {
      ...
      .catch(function(error) {
        alert("failed complete.... please try again")
      })
  }
    ...
    return (
      <div className="loader-wrapper">
        ...
        {!this.props.appStatus ? (
          ...
          <button type="button" className="applicationCompletedBtn">
        ...
        >
          <div className="detail_preview_modal_container">
            <div className="detail_preview_modal_container_inner">
              <Mutation
                mutation={MARK_COMPLETE_COVER_LETTER_REDRAFT}
                onError={this.error}
                onCompleted={data => {
              ...
              >
                {(asignSelfRequest, { data, loading, error }) => (
                  <div className="loader-wrapper">
                    ...
                    >
                      <h4 className="completeAppMTitle">
