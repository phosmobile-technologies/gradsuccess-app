...
class AllApplications extends Component {
  ...
  upadateItemCount(list) {
    list.forEach(eachApp => {
      if (eachApp.status === "Assigned" && eachApp.completed) {
        this.setState({
    ...
    return (
      <div>
        <Query
          ...
          onCompleted={data =>
            this.upadateItemCount(data.getExpertClientsCoverLetterRedraft)
          }
              ...
              <div className="form_preview">
                <div className="form_preview_inner">
                  <div className="form_preview_col_1">
                    {data.getExpertClientsCoverLetterRedraft.map(
                      (Item, index) => (
                        <div
                          key={index}
                          className={!Item.completed ? "hide_application" : ""}
                        >
        ...
        <Query
          ...
          variables={{ has_expert: this.props.expert_id }}
          onCompleted={data =>
            this.upadateItemCount(data.getExpertClientsCoverLetterReview)
          }
          fetchPolicy="no-cache"
        >
          {({ loading, error, data }) => {
            ...
            return (
              <div className="form_preview">
                <div className="form_preview_inner">
                  <div className="form_preview_col_1">
                    {data.getExpertClientsCoverLetterReview.map(
                      (Item, index) => (
                        <div
                          key={index}
                          className={!Item.completed ? "hide_application" : ""}
          ...
          {({ loading, error, data }) => {
            ...
            return (
              <div className="form_preview">
                <div className="form_preview_inner">
                  <div className="form_preview_col_1">
                    {data.getExpertClientsGraduateSchoolEssayRedraftForm.map(
                      (Item, index) => (
                        <div
                          key={index}
                          className={!Item.completed ? "hide_application" : ""}
        ...
        <Query
          ...
          variables={{ has_expert: this.props.expert_id }}
          onCompleted={data =>
            this.upadateItemCount(data.getExpertClientsResumeReviewForm)
          }
          fetchPolicy="no-cache"
        >
          {({ loading, error, data }) => {
            ...
            return (
              <div className="form_preview">
                <div className="form_preview_inner">
                  <div className="form_preview_col_1">
                    {data.getExpertClientsResumeReviewForm.map(
                      (Item, index) => (
                        <div
                          key={index}
                          className={!Item.completed ? "hide_application" : ""}
          ...
          {({ loading, error, data }) => {
            ...
            return (
              <div className="form_preview">
                <div className="form_preview_inner">
                  <div className="form_preview_col_1">
                    {data.getExpertClientsGraduateSchoolStatementReviewForm.map(
                      (Item, index) => (
                        <div
                          key={index}
                          className={!Item.completed ? "hide_application" : ""}
