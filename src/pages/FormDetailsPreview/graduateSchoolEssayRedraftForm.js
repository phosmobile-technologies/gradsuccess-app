        ...
        <Query
          ...
          onCompleted={data => {
            this.downloadUploadedFile(
              data.getGraduateSchoolEssayRedraftForm.curriculum_vitae
            )
          }}
        >
          {({ loading, error, data }) => {
            ...
            return (
              <div className="form_preview form_preview_solid_bg">
                <div className="form_preview_inner">
                  ...
                  <ExpertInCharge
                    id={data.getGraduateSchoolEssayRedraftForm.has_expert}
                  />
                  {data.getGraduateSchoolEssayRedraftForm.status ===
                    "Pending Approval" &&
                  this.props.account_type === "Admin" ? (
                    <ApproveDeclineApplicationGraduateRedraft
                      id={data.getGraduateSchoolEssayRedraftForm.id}
                  ...
                  <div className="form_preview_col_1">
                    ...
                    <div className="form_preview_fields">
                      ...
                      <p>
                        {
                          data.getGraduateSchoolEssayRedraftForm
                  ...
                  <div className="form_preview_col_1">
                    <div className="form_preview_fields">
                      <small>
                        What were your typical achievements which relates to
                        your Proposed Masters application ?
                      </small>
                      <p>
                        {
                          data.getGraduateSchoolEssayRedraftForm
                    ...
                    <div className="form_preview_fields">
                      <small>
                        Scholarships and Awards (Awarding Body, Dates)
                      </small>
                      <p>
                        {
                          data.getGraduateSchoolEssayRedraftForm
                  ...
                  <div className="form_preview_col_1">
                    <div className="form_preview_fields">
                      <small>
                        What was your final grade at Undergraduate level ?
                      </small>
                      <p>
                        {
                          data.getGraduateSchoolEssayRedraftForm
                    ...
                    <div className="form_preview_fields">
                      <small>
                        Your Result Ranking at Undergraduate level ?
                      </small>
                      <p>
                        {data.getGraduateSchoolEssayRedraftForm.result_ranking}
                      </p>
                    </div>
                  ...
                  <div className="form_preview_col_1">
                    <div className="form_preview_fields">
                      ...
                      <ul>
                        {data.getGraduateSchoolEssayRedraftForm
                          .interpersonal_skills && <li>Interpesonal Skill</li>}
                        {data.getGraduateSchoolEssayRedraftForm
                          .presentation_skills && <li>Presentation</li>}
                        {data.getGraduateSchoolEssayRedraftForm.programming && (
                          <li>Programming</li>
                        )}
                        {data.getGraduateSchoolEssayRedraftForm
                          .microsoft_excel && <li>Microsoft Excel</li>}
                        {data.getGraduateSchoolEssayRedraftForm.java && (
                          <li>Java</li>
                        )}
                      </ul>
                    </div>
                    <div className="form_preview_fields">
                      ...
                      <p>
                        {data.getGraduateSchoolEssayRedraftForm.other_skills}
                      </p>
                    </div>
                  ...
                  <div className="form_preview_col_1">
                    ...
                    <div className="form_preview_fields">
                      ...
                      <p>
                        {data.getGraduateSchoolEssayRedraftForm.certificate}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="form_preview_col_1">
                    <div className="form_preview_fields">
                      <small>Skills</small>
                      <ul>
                        {data.getGraduateSchoolEssayRedraftForm.english && (
                          <li>English</li>
                        )}
                        {data.getGraduateSchoolEssayRedraftForm.french && (
                          <li>French</li>
                        )}
                        {data.getGraduateSchoolEssayRedraftForm.german && (
                          <li>german</li>
                        )}
                        {data.getGraduateSchoolEssayRedraftForm.spanish && (
                          <li>Spanish</li>
                        )}
                      </ul>
                    </div>
                    <div className="form_preview_fields">
                      ...
                      <p>
                        {data.getGraduateSchoolEssayRedraftForm.other_languages}
                      </p>
                    </div>
                  ...
                  <div className="form_preview_col_1">
                    <div className="form_preview_fields">
                      ...
                      <p>
                        {data.getGraduateSchoolEssayRedraftForm.post_study_goal}
                      </p>
                    </div>
                    <div className="form_preview_fields">
                      <small>Referee</small>
                    ...
                    <div className="btn_wrapper">
                      ...
                      data.getGraduateSchoolEssayRedraftForm.status ===
                        ...
                        <CompleteRateGraduateStatementRedraft
                          form_id={
                            data.getGraduateSchoolEssayRedraftForm.form_id
                          }
                          applicationID={
                            data.getGraduateSchoolEssayRedraftForm.id
                          }
                          expert_id={
                            data.getGraduateSchoolEssayRedraftForm.has_expert
                          }
                          appStatus={
