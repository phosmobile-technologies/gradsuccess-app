            ...
            return (
              <div className="form_preview form_preview_solid_bg">
                <div className="form_preview_inner">
                  ...
                  {data.getResumeReviewForm.status === "Pending Approval" &&
                  this.props.account_type === "Admin" ? (
                    <ApproveDeclineApplicationResumeReview
                      id={data.getResumeReviewForm.id}
                  ...
                  <div className="form_preview_col_1">
                    ...
                    <div className="btn_wrapper">
                      ...
                      data.getResumeReviewForm.status === "Assigned" ? (
