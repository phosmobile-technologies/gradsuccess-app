                 ...
                 formSubmitted(data_info, id) {
                   ...
                   setTimeout(() => {
                     ...
                     let data = {
                       expert_id: id,
                       userID:
                         data_info.updateGraduateSchoolEssayRedraftForm.form_id,
                     }
                     fetch(url, {
                       headers: {
                     ...
                     return (
                       <div className="assign_expert_container">
                         <div className="assign_success_board">
                           ...
                           <div>
                             <p>
                               Application was successfully Assign to{" "}
                               {this.state.name}
                             </p>
                           </div>
                         </div>
                     ...
                     return (
                       <div className="assign_expert_container">
                         <h3 className="form-header">
                           Assign Application to an Expert
                         </h3>
