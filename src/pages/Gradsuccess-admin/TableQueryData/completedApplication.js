    ...
    return (
      <div>
        <Query
          ...
          onCompleted={data =>
            this.upadateItemCount(data.getAllCoverLetterRedraft)
          }
        >
          {({ loading, error, data }) => {
            if (loading)
        ...
        <Query
          ...
          fetchPolicy="no-cache"
          onCompleted={data =>
            this.upadateItemCount(data.getAllCoverLetterReview)
          }
        >
          {({ loading, error, data }) => {
            if (loading)
        ...
        <Query
          ...
          fetchPolicy="no-cache"
          onCompleted={data =>
            this.upadateItemCount(data.getAllGraduateSchoolEssayRedraftForm)
          }
        >
          {({ loading, error, data }) => {
            if (loading)
                ...
                <div className="form_preview_inner">
                  <div className="form_preview_col_1">
                    {data.getAllGraduateSchoolEssayRedraftForm === null ? (
                      ...
                      data.getAllGraduateSchoolEssayRedraftForm.map(
                        (Item, index) => (
                          <div
                            key={index}
                            className={
                              !Item.completed ? "hide_application" : ""
                            }
                          >
                            <div className="client_expert_listing_main">
                              <div>
        ...
        <Query
          ...
          fetchPolicy="no-cache"
          onCompleted={data =>
            this.upadateItemCount(data.getAllResumeReviewForm)
          }
        >
          {({ loading, error, data }) => {
            if (loading)
        ...
        <Query
          ...
          fetchPolicy="no-cache"
          onCompleted={data =>
            this.upadateItemCount(data.getAllGraduateSchoolStatementReviewForm)
          }
        >
          {({ loading, error, data }) => {
            if (loading)
                ...
                <div className="form_preview_inner">
                  <div className="form_preview_col_1">
                    {data.getAllGraduateSchoolStatementReviewForm === null ? (
                      ...
                      data.getAllGraduateSchoolStatementReviewForm.map(
                        (Item, index) => (
                          <div
                            key={index}
                            className={
