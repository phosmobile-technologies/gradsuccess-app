...
class IndexPage extends Component {
  constructor(props) {
    ...
    this.handleDisplayMessagingComponent = this.handleDisplayMessagingComponent.bind(
      this
    )
  ...
  componentDidMount() {
    ...
    if (localStorage.hasOwnProperty("currentC")) {
      ...
      switch (currentc) {
        ...
        case "ExpertsComponent": {
          this.setState({
            currentComponent: "Experts",
          })
          break
        }
        default: {
