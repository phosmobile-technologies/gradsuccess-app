...
handleCloseModal(){
  ...
  <div css={{ margin: "0 auto",backgroundColor: "rgba(0,0,0,.8)",color: '#ccc'}}>
        ...
        <Link to="/Blog">
         <button
          ...
          <button
            ...
            id = "PrivacyPolicy" 
            className = "footerBtn"
            onClick = {this.handleDisplayComponent}>Privacy Policy </button>
          <span css={slash}> / </span>
          <button
            name = "WebsiteTermOfUse" 
            id = "WebsiteTermOfUse" 
            className = "footerBtn"
            onClick = {this.handleDisplayComponent}>Website Terms of Use </button>
          <span css={slash}> / </span>
          <button
            name = "Disclaimer" 
            id = "Disclaimer" 
            className = "footerBtn"
            onClick = {this.handleDisplayComponent}>Disclaimer </button>
          <span css={slash}> / </span>
          <button
    ...
    <div css={{width: '70%',
  margin: '0 auto', paddingBottom: '10px',color:'white',fontFamily: '"Lato", "sans-serif"'}}>
