        ...
        return (
            <div>
                  ...
                  <form
                    ...
                    <div className="row-full">
                      ...
                      <div className = "selectibleList" >
                        <label>How do you rank your result in your overall graduating class at Undergraduate level?</label>
                        <div>
                          <input type="radio"
                          id ="result_ranking"
                          name="result_ranking"
                          checked={this.state.data.result_ranking === "Top 5%"}
                          onChange = {this.handleFormInput}
                          value="Top 5%" />
                          <label>Top 5%</label>
                        </div>
                        <div>
                          ...
                          id ="result_ranking"
                          name="result_ranking"
                          checked={this.state.data.result_ranking === "Top 10%"}
                          onChange = {this.handleFormInput}
                          value="Top 10%" />
                          <label>Top 10%</label>
                        </div>
                        <div>
                          <input type="radio"
                          id ="result_ranking"
                          checked={this.state.data.result_ranking === "Top 20%"}
                          onChange = {this.handleFormInput}
                          name="result_ranking"
                          value="Top 20%" />
                          <label>Top 20%</label>
                        ...
                        <div>
                          ...
                          id ="result_ranking"
                          name="result_ranking"
                          checked={this.state.data.result_ranking === "Top 50%"}
                          onChange = {this.handleFormInput}
                          value="Top 50%" />
                          <label>Top 50%</label>
                        </div>
                      ...
                      <div className = "selectibleList">
                        <label>Language at atleast Intermediate level (Good Writing/Good Understanding/Average Speaking) *</label>
                        <div>
                          <input type="checkbox"
                          name="english"
                          id ="english"
                        ...
                        <div>
                          ...
                          <label>Nigerian Language other than Native (Please describe in 'other' below)</label>
                        </div>
                        <div className = "other_skills">
                          <input type="checkbox"
              ...
              <div className = "explainInput">
                ...
                <p>
                  The information to be collected from this form would be used as a basis for your Statement of Purpose.
                </p>
                ...
                <ul>
                  ...
                  <li>
                    <h6>Which Employment is most relevant to you Masters Application?(Include Dates *</h6>
                    <p>Please provide the name of the Organization and your Role there. e.g. Laboratory Analyst at Unilever</p>
                  </li>
                  <li>
                    <h6>What were your typical achievements which relates to your Proposed Masters application ?</h6>
                  ...
                  <li>
                    <h6>What are your top 5 courses at your Undegraduate level relating to your Masters of interest?</h6>
                  </li>
                  <li>
                    <h6>What was your project/dissertation name at Undergraduate level and Grade achieved in percentage? *</h6>
                  </li>
                  <li>
                    <h6>What is the name of your most recent Undergraduate education? (Include Dates) *</h6>
                    
                  </li>
                  <li>
                    <h6>What was your final grade at Undergraduate level? (List final grade as provided on your final transcript or result) *</h6>
                  </li>
                  <li>
                    <h6>What are your top 5 courses at Undergraduate relating to your PhD of interest?</h6>
                  </li>
                  <li>
                    <h6>What was your project/dissertation name at Undergraduate level and Grade achieved in percentage?</h6>
                  </li>
                  <li>
                    ...
                    <p>List top 3 roles or leadership experiences relevant to your proposed Masters, including achievements and contexts. e.g Science Club President, University of Villanova (2013) - Organised first Industry-university symbiosis lecture on novel algae forms for gastrointestinal remediation</p>
                  </li>
                  <li>
                    <h6>Extracurricular Activities and Memberships (Include Dates)</h6>
                    <p>List all sports, clubs and society memberships</p>
                  </li>
                  <li>
                    <h6>Professional Workshops and Trainings (Organizer and Dates)</h6>
                    <p>e.g. Conflict Management and Communication Improvement, Toastmasters USA, July 12th -13th, 2015</p>
                  </li>
                  <li>
                    <h6>Academic Conferences Attended (Organising body and Dates)</h6>
                  </li>
                  <li>
                  ...
                  <li>
                    <h6>Possible modules interested in at first choice university course?</h6>
                    <p>e.g. University College London; Engineering Mechanics; Low Carbon Energy Management; Advanced Physics</p>
                  </li>
                  <li>
                    <h6>Teaching personnel/ Faculties Contacted at Institutions</h6>
                  </li>
                  
                  <li>
                    <h6>Summary of your interest</h6>
                    <p>Try to describe in few words, what you want to do and experiences that sparked the interest. e.g. I am interested in the concept of poverty alleviation through entrepreneurship. My experience working at 'workplace 1', allowed me to see the full picture of the consequences of unequal wealth distributions in most parts of emerging economies, and by studying the Masters at 'University' I believe I will be equipped with he right tools to tackle this challenges</p>
                  </li>
                  <li>
                    <h6>Post Study Goals (Career Ambitions)</h6>
                    <p>What do you possibly want to do afterwards ? and what industries? Be as clear as possible. For example ''In the short-term Strategic Consultant in Waste and Water management at top consulting firm (insert Mckinsey. BCG, AT Kearney), or general environmental issues. Longer term, seeking to open a consultancy targeted at helping small scale industries in manufacturing, production, become profitable through efficient transformations of their waste processes.''</p>
                  </li>
                  <li>
                    <h6>Referees (List Names, Addresses, Phone Numbers and Emails)</h6>
                  </li>
