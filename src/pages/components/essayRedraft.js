      ...
      return (
        <div>
            <div css={{
                ...
                <PriceBox text="STANDARD" price="N20,000" form="graduateSchoolEssayRedraft" itemDescription = 'Essay Redraft (Job Application Letter - STANDARD)'/>     <div css={{ width: '50px'}}> </div>
                <PriceBox text="FLASH PRICE" price="N30,000" form="graduateSchoolEssayRedraft" itemDescription = 'Essay Redraft (Job Application Letter - FLASH PRICE)'/>
                </div>
        </div>
    </div>
      )
