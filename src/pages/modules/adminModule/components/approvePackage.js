...
import {
  APPROVE_COVER_LETTER_REVIEW,
  APPROVE_GRADUATE_SCHOOL_STATEMENT_REVIEW,
  APPROVE_GRADUATE_SCHOOL_ESSAY_REDRAFT,
  APPROVE_RESUME_REVIEW,
  APPROVE_COVER_LETTER_REDRAFT,
} from "../../../graphql/mutations"
import ApprovePackageView from "./../views/approvePackageView"

class ApprovePackage extends Component {
  constructor(props) {
    super(props)
    this.state = {
      assigned: false,
  ...
  render() {
    return (
      <>
          ...
          {({ loading, error, data }) => {
            ...
            return (
              <ApprovePackageView
                ...
                associate={data.user}
                approvePackage={this.approvePackage}
                setOpenApproveDrawer={this.props.setOpenApproveDrawer}
              />
            )
          }}
        </Query>
        <Mutation
          mutation={APPROVE_COVER_LETTER_REVIEW}
          onCompleted={data => {
        ...
        <Mutation
          mutation={APPROVE_COVER_LETTER_REDRAFT}
          onCompleted={data => {
            this.setState({ assigned: false })
            this.props.setOpenApproveDrawer(false)
            this.processCompleted()
        ...
        <Mutation
          mutation={APPROVE_GRADUATE_SCHOOL_STATEMENT_REVIEW}
          onCompleted={data => {
            this.setState({ assigned: false })
            this.props.setOpenApproveDrawer(false)
            this.processCompleted()
        ...
        <Mutation
          mutation={APPROVE_GRADUATE_SCHOOL_ESSAY_REDRAFT}
          onCompleted={data => {
            this.setState({ assigned: false })
            this.props.setOpenApproveDrawer(false)
            this.processCompleted()
        ...
        <Mutation
          mutation={APPROVE_RESUME_REVIEW}
          onCompleted={data => {
            this.setState({ assigned: false })
            this.props.setOpenApproveDrawer(false)
            this.processCompleted()
