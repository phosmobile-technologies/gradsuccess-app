...
import AdminAwaitingApprovalView from "./../views/awaitingApprovalView"

class AdminAwaitingApplication extends Component {
  constructor(props) {
    super()
    this.state = {
      newPackages: [],
    ...
    return (
      ...
      >
        {({ loading, error }) => {
          ...
          return (
            <DashboardLayout
              body={<AdminAwaitingApprovalView data={this.state.newPackages} />}
              routes={admin_nav_routes}
              title="Awaiting Applications"
            />
          )
...
export default AdminAwaitingApplication
