...
class DeclinePackageView extends Component {
  constructor(props) {
    super(props)
    this.state = {
      associate: null,
        ...
        return (
          <div className="assign-self-container">
            <Card interactive={true} elevation={Elevation.ONE}>
              ...
              <p>
                {truncateString(
                  this.state.packageItem.summary_of_interest,
                  300
                )}
              </p>
              <Divider />
              ...
              <div className="a-s-btns">
                <Button
                  ...
                  onClick={() => this.props.declinePackage()}
                >
                  Decline Request
                </Button>
                <Button
...
export default DeclinePackageView
