...
import AssociateAssignApplicationView from "./../views/assignApplicationView"

class AssociateAssignedApplication extends Component {
  constructor(props) {
    super()
    this.state = {
      newPackages: [],
        ...
        >
          {({ loading, error }) => {
            ...
            return (
              <DashboardLayout
                body={
                  <AssociateAssignApplicationView
