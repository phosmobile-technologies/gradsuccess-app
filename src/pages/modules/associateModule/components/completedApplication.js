...
import AssociateCompletedApplicationView from "./../views/completedApplicationView"

class AssociateCompletedApplication extends Component {
  constructor(props) {
    super()
    this.state = {
      newPackages: [],
        ...
        >
          {({ loading, error }) => {
            ...
            return (
              <DashboardLayout
                body={
                  <AssociateCompletedApplicationView
