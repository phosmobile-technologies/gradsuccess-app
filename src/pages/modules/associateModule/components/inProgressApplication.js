...
import AssociateInProgressApplicationView from "./../views/inProgressApplicationView"

class AssociateInProgressApplication extends Component {
  constructor(props) {
    super()
    this.state = {
      newPackages: [],
      ...
      >
        {({ loading, error }) => {
          ...
          return (
            <DashboardLayout
              body={
                <AssociateInProgressApplicationView
...
export default connect(
  mapStateToProps,
  null
)(AssociateInProgressApplication)
