       ...
       <div>
         <div className="package-content-wrapper">
           ...
           <p>
             ...
             essay review service is best suited if you already have an essay
           ...
           <p>
             ...
             and weaknesses and provide an Initial Aggregate Score (IAS) to show
             how suited and aligned your current Essay is for your prospective
             application.
           </p>
           <p>
           ...
           <ul className="content-ul">
             ...
             <li>
               {" "}
               Propositions for structured and clearly stated problem statements{" "}
             </li>
             <li>
               {" "}
           ...
           <div className="price-box-wrapper">
             <PriceBox
               text="STANDARD"
               price="N18,500"
               packageDetail={packages.admission_grad_sch_essay_review_reg}
             />
             <PriceBox
               text="FLASH PRICE"
               price="N25,000"
               packageDetail={packages.admission_grad_sch_essay_review_fla}
             />
           </div>
         </div>
         {/* End  */}
