...
import {
  CREATE_GRADUATE_SCHOOL_STATEMENT_REVIEW,
  CREATE_PACKAGE,
...
const initialState = {
  data: {
    name: null,
    university_and_course_applied_for: null,
                        ...
                        if (this.validator.allValid()) {
                          ...
                          createPackage({
                            variables: {
                              ...
                              form_type: "GRADUATE_SCHOOL_STATEMENT_REVIEW",
                            },
                          })
                        } else {
...
export default GraduateSchoolStatementReview
