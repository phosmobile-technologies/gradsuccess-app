...
export default class UploadProfileImage extends React.Component {
  ...
  onChange(e) {
    ...
    let fileRef =
      "ProfileImages/" + imageName + "_" + timeSubmitted + "_" + file.name
      ...
      <div>
        <div className="expert-form">
          ...
          <form className="checkout-form-container">
            ...
            <div
              className={
                this.state.file !== "" ? "uploadImg" : "hide-upload-img"
              }
            >
              <img src={this.state.file} alt = "profile"/>
              <label htmlFor="file">change</label>
            </div>
            <div
              className="p-image"
              id={this.state.file !== "" ? "hide-d-img" : ""}
            >
              <div>
                <img id="previewimg" src={defaultImage} alt = "profile" />
              </div>
