      ...
      <div>
        <div className="package-content-wrapper">
          ...
          <p>
            ...
            revisions so you can provide feedback and additions three more times
            after the initial draft. Once we have your feedback, a final draft
          ...
          <div className="price-box-wrapper">
            <PriceBox
              text="STANDARD"
              price="₦20,000"
              packageDetail={packages.scholarship_resume_redraft_reg}
            />
            <PriceBox
              text="FLASH PRICE"
              price="₦30,000"
              packageDetail={packages.scholarship_resume_redraft_fla}
            />
          </div>
        </div>
      </div>
