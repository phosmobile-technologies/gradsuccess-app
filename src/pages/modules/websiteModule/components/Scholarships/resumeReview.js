        ...
        <div>
          <div className="package-content-wrapper">
            ...
            <p>
              ...
              panelists, HR personnel and even the bot who will be screening
              these one-pagers.
            </p>
            <p>
              {" "}
            ...
            <ul className="content-ul step-2">
              <li>
                <b>
                  <span>
                    <i>Appearance </i>
            ...
            <div className="price-box-wrapper">
              <PriceBox
                text="STANDARD"
                price="₦10,000"
                packageDetail={packages.scholarship_resume_review_reg}
              />
              <PriceBox
                text="FLASH PRICE"
                price="₦15,000"
                packageDetail={packages.scholarship_resume_review_fla}
              />
            </div>
          </div>
          {/* End  */}
