...
<p>This website is owned and operated by Gradsuccess.org, Ltd (“Company,” “we,” or “us”).
This Disclaimer, along with the Website Terms of Use, and Privacy Policy, governs your access to and use of gradsuccess.org, including any content, functionality and services offered on or through gradsuccess.org and its sub-domains (the “Website”), whether as a guest or a registered user.</p>
<p>Please read the Disclaimer carefully before you start to use the Website. By using the Website, you accept and agree to be bound and abide by the Disclaimer. If you do not want to agree to the Disclaimer, you must not access or use the Website.</p>
...
<p>The information contained on this Website and the resources available for download through this website is not intended as, and shall not be understood or construed as, professional advice. While the information provided on this Website relates to issues within the Company’s area of professionalism, the information contained on this Website is not a substitute for advice from a professional who is aware of the facts and circumstances of your individual situation.</p>
...
Neither the Company nor any of its consultants, employees or other representatives shall be held liable or responsible for any errors or omissions on this website or for any damage you may suffer as a result of failing to seek competent advice from a professional who is familiar with your situation.</p>

<h3>No Professional-Client Relationship</h3>
<p>Your use of this Website – including implementation of any suggestions set out in this Website and/or use of any resources available on this Website – does not create a professional-client relationship between you and the Company or any of its professionals.
...
You also recognize that prior results do not guarantee a similar outcome.  Thus, the results obtained by others – whether clients or customers of the Company or otherwise – applying the principles set out in this Website are no guarantee that you or any other person or entity will be able to obtain similar results.</p>
...
 
<p>We will disclose the existence of any discounts or incentives received in exchange for providing a review of a product. If you would like more information about any such discounts and incentives, send an email to support@gradsuccess.org that includes the title of the reviewed product as the subject line. We will respond via email and disclose any incentives or discounts we received in association with any such review.</p>
