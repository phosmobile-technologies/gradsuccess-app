  ...
  render() {
    return (
      <div className="terms_services">
        <h1>Disclaimer</h1>
        <p>
          This website is owned and operated by Gradsuccess.org, Ltd (“Company,”
          “we,” or “us”). This Disclaimer, along with the Website Terms of
          Use, and Privacy Policy, governs your access to and use
          of gradsuccess.org, including any content, functionality and services
          offered on or through gradsuccess.org and its sub-domains (the
        ...
        <p>
          ...
          abide by the Disclaimer. If you do not want to agree to the
          Disclaimer, you must not access or use the Website.
        </p>
        ...
        <p>
          ...
          understood or construed as, professional advice. While the information
          provided on this Website relates to issues within the Company’s area
          of professionalism, the information contained on this Website is not a
          substitute for advice from a professional who is aware of the facts
        ...
        <p>
          ...
          address your particular situation. The Company expressly recommends
          that you seek advice from a professional. Neither the Company nor any
          of its consultants, employees or other representatives shall be held
        ...
        <p>
          Your use of this Website – including implementation of any suggestions
          set out in this Website and/or use of any resources available on this
          Website – does not create a professional-client relationship between
          you and the Company or any of its professionals. The Company cannot
          accept you as a client unless and until we determine that there is a
          fit and until various requirements, such as fee arrangements, are
          resolved.  Thus, you recognize and agree that we have not created any
          professional-client relationship by the use of this Website.
        </p>
        <h3>User’s Personal Responsibility </h3>
        <p>
        ...
        <p>
          ...
          are intended to help users of this website. You nevertheless recognize
          ...
          circumstances beyond the control and/or knowledge of the Company. You
          also recognize that prior results do not guarantee a similar outcome.
           Thus, the results obtained by others – whether clients or customers
          of the Company or otherwise – applying the principles set out in this
        ...
        <p>
          ...
          complete, and up-to-date.  We have taken reasonable steps to ensure
          that the information contained in this Website is accurate, but we
          cannot represent that this Website is free of errors. You accept that
          the information contained on this Website may be erroneous and agree
          to conduct due diligence to verify any information obtained from this
          Website and/or resources available on it prior to taking any action.
           You expressly agree not to rely upon any information contained in
          this website.
        </p>
        <h3>Reviews</h3>
        <p>
          ...
          software applications. Any such reviews will represent the good-faith
          opinions of the author of such review. The products and services
          reviewed may be provided to the Company for free or at a reduced price
          as an incentive to provide a review.
        </p>
        <p>
        ...
        <p>
          ...
          email to support@gradsuccess.org that includes the title of the
          reviewed product as the subject line. We will respond via email and
          disclose any incentives or discounts we received in association with
          any such review.
        </p>
        ...
        <p>
          ...
          ANY PORTION OF THE WEBSITE, OR WITH ANY OF THESE WEBSITE TERMS OF
