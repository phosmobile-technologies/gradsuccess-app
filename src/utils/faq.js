...
render() {
    return(  
        <div className= "terms_services">
            ...
            <li>What Services do you render?</li>
            ...
            <li>How long do I have to wait?</li>
            ...
            <li>Can I get multiple revisions?</li>
