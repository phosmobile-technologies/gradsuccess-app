      ...
      <div className="terms_services">
        ...
        <p>
          <strong>
            ...
            Gradsuccess.org, Ltd. (“Company”, “we”, or “us”).
          </strong>
        </p>
        ...
        <p>
          ...
          Use”), govern your access to and use of gradsuccess.org, including any
          content, functionality and services offered on or
          through gradsuccess.org, (the “Website”), whether as a guest or a
          registered user. Please read the Terms of Use carefully before you
          start to use the Website. By using the Website, you accept and agree
          to be bound and abide by these Terms of Use, our Privacy
          Policy, incorporated herein by reference, and our Disclaimer,
          incorporated herein by reference. If you do not want to agree to these
          Terms of Use including the agreements incorporated by reference
        ...
        <h3>Price Change Policy</h3>
        <p>
          We may revise and update the prices of the services and products that
          we offer at any time without notice.
        </p>
        ...
        <p>
          ...
          Website and informs users of our data collection practices. Your
        ...
        <h3>Disclaimer</h3>
        <p>
          Your use of the Website is also subject to the
          Company’s Disclaimer. Please review our Disclaimer, which also governs
          the Website and informs users of various limitations regarding the
        ...
        <p>
          ...
          is a condition of your use of the Website and any resources downloaded
          from the Website that all the information you provide on the Website
        ...
        <h3>No Unlawful Or Prohibited Use And Intellectual Property</h3>
        <p>
        ...
        <p>
          As a condition of your use of the Website, you warrant to the Company
          that you will not use the Website or any of the resources available
          for download from the Website for any purpose that is unlawful or
          prohibited by these Terms. You may not use the Website or any of the
          resources available for download from the Website in any manner that
          could damage, disable, overburden, or impair the Website or interfere
          with any other party’s use and enjoyment of the Website. You may not
        ...
        <p>
          All content included as part of the Website, such as text, graphics,
        ...
        <p>
          ...
          exploit any of the content, in whole or in part, found on the Website
          or any of the resources available for download from the Website.
        </p>

        <p>
          The Company content is not for resale. Your use of the Website or any
          of the resources available for download from the Website does not
        ...
        <p>
          ...
          are trademarks or service marks of the Company or its affiliates or
          ...
          names, designs and slogans on this Website are the trademarks or
          service marks of their respective owners.
        </p>
        <p>
          Under the following limited circumstances, the Company grants
          permission to use information from this Website without the Company’s
          express written permission:
        </p>
        <p>
          Individuals involved in admissions counseling may quote from this
          website provided the material in which it is quoted contains the
          following notice, “This information is provided by Gradsuccess.org.
          Further information is available at http://www.gradsuccess.org or via
          e-mail at support@gradsuccess.org.” Individuals, schools, and
          companies may reproduce articles from this website for use on their
          websites provided they attribute the articles to Gradsuccess, do not
          alter, transform or modify them, and maintain all links contained in
          the article.
        </p>
        ...
        <p>
          ...
          Website are for educational and informational purposes only. The
          information contained on this Website and the resources available for
          download through this Website is not intended as, and shall not be
          understood or construed as legal, financial, tax, medical, health, or
          any other professional advice.
        </p>

        <h3>Accuracy And Personal Responsibility</h3>
        <p>
          ...
          from a professional who is familiar with your situation. By using this
          Website, you accept personal responsibility for the results of your
          ...
          this Website. You agree to use judgment and conduct due diligence
          before taking any actions or implementing any plans or policy
          suggested or recommended on this Website.
        </p>

        <h3>No Guarantees as To Results</h3>
        <p>
          ...
          educational and informational resources that are intended to help
          users of this Website succeed. You nevertheless recognize that your
          ultimate success or failure will be the result of your own efforts,
          your particular situation, and innumerable other circumstances beyond
          the control and/or knowledge of the Company.
        </p>

        <p>
          You also recognize that prior results do not guarantee a similar
          outcome.  Thus, the results obtained by others - whether clients of
          the Company or otherwise - applying the principles set out in this
          Website are no guarantee that you or any other person or entity will
        ...
        <p>
          ...
          designed to enable you to communicate with the public at large or with
          a group (collectively, “Communication Services”), you agree to use the
        ...
        <p>
          ...
          However, the Company reserves the right to review materials posted to
          a Communication Service and to remove any materials in its sole
          discretion. The Company reserves the right to terminate your access to
        ...
        <p>
          ...
          in any Communication Service and, therefore, the Company specifically
          ...
          Service. Managers and hosts are not authorized the Company
          spokespersons, and their views do not necessarily reflect those of the
          Company.
        </p>
        ...
        <h3>Materials Provided To The Website</h3>
        ...
        <p>
          ...
          in the Company’s sole discretion. By posting, uploading, inputting,
          providing, or submitting your Submission you warrant and represent
          that you own or otherwise control all of the rights to your Submission
          as described in this section including, without limitation, all the
        ...
        <h3>Use of Paid Courses, Programs, and Associated Material</h3>
        <p>
          The Company may from time-to-time provide various courses, programs,
          ...
          “Courses”) for your own personal or internal business use. Except as
          otherwise provided, you acknowledge and agree that you have no right
          to modify, edit, copy, reproduce, create derivative works of, reverse
          engineer, alter, enhance or in any way exploit any of the Courses in
          any manner.
        </p>
        ...
        <h3>Use Of Free Downloadable Content</h3>
        <p>
        ...
        <p>
          By downloading the Freemium Content, you further agree that you shall
          not create any derivative work based upon the Freemium Content and you
          shall not offer any competing products or services based upon any
        ...
        <p>
          ...
          CONDITION OF ANY KIND. THE COMPANY AND/OR ITS SUPPLIERS HEREBY
        ...
        <p>
          ...
          expressly agree to present such claim only through binding arbitration
          to occur in Lagos, Nigeria. You further agree to and do hereby waive
          any right to class arbitration and agree, instead, to conduct an
          arbitration related solely to any individual claims you and/or any
          entity related to you asserts against the Company. To the fullest
          extent permissible by law, you further agree that you shall be
        ...
        <p>
          The Website is controlled, operated and administered by the Company
          from our offices within the Nigeria. If you access the Website from a
          location outside the Nigeria, you are responsible for compliance with
        ...
        <p>
          ...
          laws, rules or regulations. The Company reserves the right, at its own
        ...
        <h3>Termination And Access Restriction</h3>
        <p>
          ...
          by law, and you hereby consent to resolve any and all disputes arising
          under or related to this Website or the Terms of Use pursuant to the
          Arbitration Resolution Clause above. Use of the Website is
        ...
        <h3>No Joint Venture Or Other Relationship</h3>
        <p>
          ...
          provided to or gathered by the Company with respect to such use. If
        ...
        <p>
          Unless otherwise specified herein, this agreement, along with
          the Privacy Policy and Disclaimer, constitutes the entire agreement
          ...
          whether electronic, oral or written, between the user and the Company
          with respect to the Website. A printed version of this agreement and
          ...
          agreement and all related documents be written in English. This
          Agreement shall be interpreted through its plain and literal meaning
        ...
        <p>
          The Company reserves the right, in its sole discretion, to change the
          Terms under which the Website is offered. The most current version of
          the Terms will supersede all previous versions. The Company encourages
